...
const Home = () => {
  ...
  const slides2 = [
    {
      title: 'Your Office, Your Home',
      description: 'This is the first feature of Slider 2.',
      image: 'Frontend/src/assets/slider2.jpg',
      link: 'https://forms.gle/h55NZdsNK5EeskDm8',
    },
    {
      title: 'Filed Executive',
    ...
    {
      title: 'Delivery Boy Courier Boy',
